...
public enum PlatformHttpStatus
{
     ...
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#SUCCESSFUL}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#REDIRECTION}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#CLIENT_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#CLIENT_ERROR} or
     * {@link org.SwinglabHttpStatus.http.HttpStatus.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     * @since 5.0
