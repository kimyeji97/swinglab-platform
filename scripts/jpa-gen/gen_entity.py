...
main_path = os.path.realpath(os.path.join(dir_path, '../../src/main' ))
model_path =os.path.join(main_path, 'java', 'com','dailystudy','swinglab','service','framework','gen','entity')
...
gen_domain_package = "com.dailystudy.swinglab.service.framework.gen.entity"
